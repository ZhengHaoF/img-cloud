...
- [imgCloud](#imgcloud)
  ...
  - [安装教程（新版）](#安装教程新版)
    ...
    - [（三）前端安装](#三前端安装)
    - [（四）创建超级管理员](#四创建超级管理员)
  - [安装教程（旧版） -- 从源码编译安装](#安装教程旧版----从源码编译安装)
    - [（一）事前准备](#一事前准备-1)
    - [（二）部署后端](#二部署后端-1)
    - [（三）编译前端](#三编译前端)
  - [使用说明](#使用说明)
  ...
  - [增量更新](#增量更新)
  - [更新日志](#更新日志)
    - [2022.05.05 v1.0.2-beta](#20220505-v102-beta)
    - [2022.05.02 v1.0.1-beta](#20220502-v101-beta)
    - [2022.04.06 v1.0.0-beat](#20220406-v100-beat)
    - [2022.03.30](#20220330)
    - [2022.03.28](#20220328)
    - [2022.03.06](#20220306)
    - [2022.02.25](#20220225)
...
## 增量更新
如果您已经提前部署了imgCloud之前的版本。增量更新只需两部。
1. 全部替换前端。
2. 后端增量更新只需下载增量更新包，上传覆盖`tp`文件夹即可



## 更新日志

### 2022.05.05 v1.0.2-beta
1. 新增站点Logo、站点名称、版权信息的自定义修改功能。

### 2022.05.02 v1.0.1-beta
1. 复制链接弹出提示框
